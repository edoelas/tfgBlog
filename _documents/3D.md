...
![Ragnarok Online](./../assets/images/ragnarokOnline.jpg){:.img}
...
![Octopath Traveler](./../assets/images/octopathTraveler.jpg){:.img}
...
![Gamasutra - Art Design Deep Dive: Using a 3D pipeline for 2D ...](./../assets/images/1_Model3DS.gif){:.img}

![Art Design Deep Dive: Using a 3D pipeline for 2D animation in Dead ...](./../assets/images/9fea3054095af7860576a5d9349a8361.gif){:.img}

![Gamasutra - Art Design Deep Dive: Using a 3D pipeline for 2D ...](./../assets/images/8_Move.gif){:.img}
...
![image-20200527135422186](./../assets/images/image-20200527135422186.png){:.img}
...
![[animate output image]](./../assets/images/ezgif-5-779f18c65cb4.gif){:.img}
...
- The width of the sprites will be 64 and the height 90. This numbers came from the assumption that 1 metre in the game will be 32 pixels. 
  ...
  ![image-20200527141826875](./../assets/images/image-20200527141826875.png){:.img}
